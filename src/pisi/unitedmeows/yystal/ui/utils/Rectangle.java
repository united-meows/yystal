...
public class Rectangle {
	...
	public Rectangle(final Vector4f vector) { this.vector = vector; }

	public Rectangle(final float x, final float y, final float z, final float w) { this.vector = new Vector4f(x, y, z, w); }

	public Rectangle(final float[] xyzw) { this.vector = new Vector4f(xyzw[0], xyzw[1], xyzw[2], xyzw[3]); }
	...
	public void draw(final int color) { draw(color, color); }
	...
	public void draw(final int color, final int endColor) {
		...
		glColor4f((endColor >> 16 & 255) / 255.0F, (endColor >> 8 & 255) / 255.0F, (endColor & 255) / 255.0F, (endColor >> 24 & 255) / 255.0F);
